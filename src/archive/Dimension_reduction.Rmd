...
For each pair of points $$x_i$$ and $$x_j$$, compute the conditional probability $$p_{j|i}$$ that $$x_i$$ would pick $$x_j$$ 
as its neighbor. 
...
as its neighbor, based on their distance and the density of points around $$x_i$$.
